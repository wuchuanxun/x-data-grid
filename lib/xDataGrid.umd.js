...
/* harmony default export */ var x_data_grid = ({
  ...
  computed: {
    fuse: function fuse() {
      return new fuse_esm(this.source, this.options);
    }
  },
  render: function render(createElement) {
    ...
    if (this.pageSize > 0) {
      ...
      var infoDom = createElement('span', "\u5171\u6709\u6570\u636E".concat(this.source.length, "\u6761, \u7B5B\u9009\u7ED3\u679C").concat(this.filterSource.length, "\u6761"));
  ...
  mounted: function mounted() {
    ...
    this.filterSource = this.source; // 缩放列
