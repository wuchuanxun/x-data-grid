...
function x_data_grid_index(obj, i) {
  return obj[i];
}

var getValue = function getValue(obj, key) {
  if (key) {
    return key.split('.').reduce(x_data_grid_index, obj);
  } else {
    return obj;
  }
};
...
/* harmony default export */ var x_data_grid = ({
  ...
  render: function render(createElement) {
    ...
    renderData.forEach(function (row, rindex) {
      ...
      that.columns.forEach(function (cell) {
        ...
        var tdContent = getValue(row, cell.key);
  ...
  created: function created() {
    ...
    if (this.sortType !== 'normal') {
      ...
      this.filterSource.sort(function (a, b) {
        return _that.sortFn(a[_that.sortKey], b[_that.sortKey]) * dir;
      });
    } // 缩放列
