...
/* harmony default export */ var x_data_grid = ({
  ...
  render: function render(createElement) {
    ...
    var renderData = this.filterSource; // 分页
    ...
    var infoDom = createElement('span', "\u5171\u6709\u6570\u636E".concat(this.sourceLocal.length, "\u6761, \u7B5B\u9009\u7ED3\u679C").concat(this.filterSource.length, "\u6761"));
        ...
        on: {
          'input': Object(debounce["debounce"])(function (e) {
            ...
            if (text.length === 0) {
              ...
              that.filterSource = that.fuse.search(text).map(function (p) {
                return p.item;
              });
            }
  ...
  watch: {
    source: function source() {
      ...
      if (this.searchSchema.trim() === '') {
        ...
        this.filterSource = this.fuse.search(this.searchSchema).map(function (p) {
          return p.item;
        });
      } // 重新排序
