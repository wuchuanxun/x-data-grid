(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["xDataGrid"] = factory();
	else
		root["xDataGrid"] = factory();
...
/* harmony default export */ var x_data_grid = ({
  ...
  computed: {
    fuse: function fuse() {
      return new fuse_esm(this.sourceLocal, this.options);
    }
  },
  render: function render(createElement) {
    ...
    var renderData = this.filterSource;
        ...
        trs.push(createElement('tr', {
          ...
          on: {
            click: function click() {
              if (that.clickExpand) {
                that.$set(row, '_expanded', !row._expanded); // 强制刷新
    ...
    if (!this.hiddenInfo) {
      var t = "\u5171".concat(this.sourceLocal.length, "\u6761\u6570\u636E");
      ...
      if (this.checkedKeys.length > 0) {
        t += "\uFF0C\u5DF2\u9009".concat(this.checkedKeys.length, "\u6761");
      }
        ...
        on: {
          'input': Object(debounce["debounce"])(function (e) {
            ...
            if (text.length === 0) {
              ...
              that.filterSource = that.fuse.search(that.options.prefix + text).map(function (p) {
                return p.item;
              });
            }
  ...
  watch: {
    source: function source() {
      ...
      this.checkedKeys = this.sourceLocal.filter(function (p) {
        return p._checked;
      }).map(function (p) {
        return p[rowKey];
      });
      ...
      if (this.searchSchema.trim() === '') {
        ...
        this.filterSource = this.fuse.search(this.options.prefix + this.searchSchema).map(function (p) {
          return p.item;
        });
      } // 重新排序
  ...
  created: function created() {
    ...
    this.filterSource = this.sourceLocal; // 默认排序
...
//# sourceMappingURL=xDataGrid.umd.js.map